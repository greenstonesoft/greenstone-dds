...
static constexpr size_t ENTITYID_SIZE{ 4UL };
...
static constexpr size_t KEY_INDEX3{ 3UL };
static constexpr octet KEY_MASK{ 0xFFU };
static constexpr octet KIND_MASK{ 0xFFU };
static constexpr octet BUILTIN_KIND_MASK{ 0xF0U };
static constexpr octet BUILTIN_KIND{ 0xC0U };
 ...
 */
using GroupDigest_t = std::array<octet, 4U>;
using GroupDigest = GroupDigest_t;

constexpr GroupDigest GROUP_DIGEST_EMPTY{0U};
...
{
    static constexpr size_t KEY_SIZE_ {3UL};
    static constexpr size_t KEY_INDEX0_ {0UL};
    static constexpr size_t KEY_INDEX1_ {1UL};
    static constexpr size_t KEY_INDEX2_ {2UL};
    static constexpr size_t OFFSET_24_ {24UL};
    static constexpr size_t OFFSET_16_ {16UL};
    static constexpr size_t OFFSET_8_ {8UL};
    std::array<octet, KEY_SIZE_> const &entityKey {entityId.entity_key()};
    guint32_t const key {
        (static_cast<guint32_t>(entityKey[KEY_INDEX0_]) << OFFSET_24_) |
        (static_cast<guint32_t>(entityKey[KEY_INDEX1_]) << OFFSET_16_) |
        (static_cast<guint32_t>(entityKey[KEY_INDEX2_]) << OFFSET_8_)};
