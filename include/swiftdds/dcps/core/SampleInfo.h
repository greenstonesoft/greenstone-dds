...
#include "swiftdds/dcps/core/SampleIdentity.h"
...
public:
    ...
    DDS::SampleStateMask sample_state { static_cast<DDS::SampleStateMask>(DDS::SampleStateKind::READ_SAMPLE_STATE) };
    ...
    DDS::ViewStateMask view_state { static_cast<DDS::ViewStateMask>(DDS::ViewStateKind::NEW_VIEW_STATE) };
     ...
     */
    DDS::InstanceStateMask instance_state { static_cast<DDS::InstanceStateMask>(DDS::InstanceStateKind::ALIVE_INSTANCE_STATE) };
     ...
     */
    gint32_t disposed_generation_count {0};
     ...
     */
    gint32_t no_writers_generation_count {0};
     ...
     */
    gint32_t absolute_generation_rank {0};
    ...
    /*
     * The is_gs_vendor flag that indicates whether the DataSample is the data sent by the greenstone vendor's dds 
     */
    gbool_t is_gs_vendor {true};

    /*
     * The sample_identity that indicates the related sample identity (Extension for the future)
     */
    dds::core::SampleIdentity sample_identity{};
