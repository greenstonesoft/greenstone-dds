...
* All rights reserved
**************************************************************/
#ifndef SUBSCRIPTIONBUILTINTOPICDATA_H
#define SUBSCRIPTIONBUILTINTOPICDATA_H 1
...
namespace dds {
namespace topic {
    guint32_t const SUB_SECURITY_INFO_LENGTH{ 2U };     ///< Length of SubscriptionBuiltinTopicData's security info.
    /**
     * @class SubscriptionBuiltinTopicData
     * @brief Information on a subscription that is currently "associated" with the DataWriter, that is, a subscription with a matching Topic and 
     *        compatible QoS that the application has not indicated should be "ignored" by means of the DomainParticipant ignore_subscription operation.
     */
    class GS_DDS4CPP_API SubscriptionBuiltinTopicData
    {
    public:
        /**
         * @brief Constructer of the SubscriptionBuiltinTopicData class.
         */
        SubscriptionBuiltinTopicData() { m_reliability.kind(dds::qos::ReliabilityQosPolicyKind::BEST_EFFORT_RELIABILITY_QOS); }
        
        /**
         * @brief Constructor of the class SubscriptionBuiltinTopicData by another Publisher object.
         * @param [in] other Const reference of a SubscriptionBuiltinTopicData object.
         */
        SubscriptionBuiltinTopicData(SubscriptionBuiltinTopicData const& other) = default;
        
        /**
         * @brief Move constructor of the class SubscriptionBuiltinTopicData.
         * @param [in] other Rvalue reference of this SubscriptionBuiltinTopicData object.
         */
        SubscriptionBuiltinTopicData(SubscriptionBuiltinTopicData&& other) = default;
        
        /**
         * @brief Assign a SubscriptionBuiltinTopicData object to the current SubscriptionBuiltinTopicData object.
         * @param [in] other Const reference of a SubscriptionBuiltinTopicData object.
         * @return Reference of this SubscriptionBuiltinTopicData object.
         */
        SubscriptionBuiltinTopicData& operator=(SubscriptionBuiltinTopicData const& other) = default;
        
        /**
         * @brief Move assignment of the class SubscriptionBuiltinTopicData.
         * @param [in] other Rvalue reference of this SubscriptionBuiltinTopicData object.
         * @return Reference of this SubscriptionBuiltinTopicData object.
         */
        SubscriptionBuiltinTopicData& operator=(SubscriptionBuiltinTopicData&& other) = default;
        
        /**
         * @brief Deconstructer of the class SubscriptionBuiltinTopicData.
         */
        virtual ~SubscriptionBuiltinTopicData() = default;
        ...
        /**
         * @brief This function get the DisablePositiveACKsQosPolicy.
         * @return Const reference of the DisablePositiveACKsQosPolicy
         */
        ...
        /**
         * @brief This function set the DisablePositiveACKsQosPolicy.
         * @param [in] value Const reference of the DisablePositiveACKsQosPolicy to be set to
         */
        ...
        inline gvoid_t recv_max_frag_size(guint32_t const value) noexcept
        {
        ...
        {
            std::array<uint32_t, SUB_SECURITY_INFO_LENGTH> t;
        ...
        inline gvoid_t deserialize_msg_max_size(DdsCdr& cdr, guint16_t const id) noexcept
        {
            cdr.deserialize(&m_recvMaxFragSize, 1U, id);
        }
