...
#include "swiftdds/dcps/domain/DomainParticipantFactoryQos.h"
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		* @brief This function return DomainParticipantFactoryQos's ThreadInatance status of the DomainParticipantFactory.
		* @return Return gbool_t
		*/
		gbool_t get_thread_instance_status() const noexcept;

		/**
		* @brief This function return the set of udp port numbers currently DomainParticipantFactory in use
		* @return Return std::vector<guint32_t>
		*/
		std::vector<guint32_t> get_used_udp_ports() noexcept;
