...
#include "swiftdds/dcps/domain/DomainParticipantQos.h"
...
#include "swiftdds/dcps/topic/ContentFilteredTopic.h"
#include "swiftdds/dcps/topic/MultiTopic.h"
#include "swiftdds/dcps/sub/SubscriberQos.h"
#include "swiftdds/dcps/sub/DataReaderQos.h"
#include "swiftdds/dcps/pub/PublisherQos.h"
...
#include "swiftdds/dcps/topic/TopicBuiltinTopicData.h"
...
namespace domain
{
    ...
    public:
        ...
        /**
         * @brief The operation find_topic gives access to an existing enabled Topic, based on its name and type name.
         * @param [in] topic_name The name of the Topic.
         * @param [in] type_name The name of the type that the topic use.
         * @return Return Topic* or nullptr.
         * @retval nullptr If it dose not find a Topic* has a_topic_name, it returns nullptr.
         */ 
        dds::topic::Topic* find_topic(gstring_t const & topic_name, gstring_t const & type_name) noexcept;
