    ...
    */
    ...
    public:        
        ...
        */
        ...
        /**
        * @brief This function gets the value of 'm_enableMergeData' parameter.
        * @return Return true or false.
        * @retval true  It enables merge data.
        * @retval false It disables merge data.
        */
        inline gbool_t const& enable_merge_data() const noexcept
        {
            return m_enableMergeData;
        }
        ...
        */
        ...
        /**
        * @brief This function sets the value of 'm_enableMergeData' parameter.
        * @param [in] a_enable_group_send Const reference of a gbool_t.
        */
        inline void enable_merge_data(gbool_t const& a_enable_merge_data) noexcept 
        {
            m_enableMergeData = a_enable_merge_data;
        }
        ...
        */
        ...
        /**
        * @brief Setting enable info dst msg
        * @param [in] value true - send heartbeat with info dst submsg
        */
        inline void enable_info_dst_msg(bool const value) noexcept
        {
            m_enableInfoDstMsg = value;
        }

        /**
        * @brief Is enable info dst msg?
        */
        inline bool enable_info_dst_msg() const noexcept
        {
            return m_enableInfoDstMsg;
        }
