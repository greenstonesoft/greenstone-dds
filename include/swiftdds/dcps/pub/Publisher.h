...
namespace pub
{
    ...
    */
    ...
    public:
        ...
        * @todo
        */
        DDS::ReturnCode_t suspend_publications() noexcept;
        ...
        * @todo
        */
        DDS::ReturnCode_t resume_publications() noexcept;
        ...
        * @todo
        */
        DDS::ReturnCode_t begin_coherent_changes() noexcept;
        ...
        * @todo
        */
        DDS::ReturnCode_t end_coherent_changes() noexcept;
        ...
        */
        DDS::ReturnCode_t wait_for_acknowledgements(gstone::rtps::Duration_t const &max_wait) noexcept;
        ...
        * @todo
        */
        DDS::ReturnCode_t copy_from_topic_qos(DataWriterQos &a_datawriter_qos, dds::topic::TopicQos const &a_topic_qos) const noexcept;
