...
namespace xtypes
{
    ...
    public:
        ...
        inline std::map<MemberId, DynamicTypeMember *> const &get_all_members() const noexcept { return m_member; }
         ...
         */
        inline bool const is_with_key() const noexcept
        {
            return m_isKeyDefined;
        }

        /**
         * @brief  This operation checks whether or not the given type is with id.
         * @return true If this type is annotated by an \@id annotation.
         * @return false If this type is not annotated by an \@id annotation.
         */
        bool const is_with_at_id() const;
        
        /**
         * @brief  This operation checks whether or not the given type is with auto id.
         ...
         */
        bool const is_with_auto_id() const;
