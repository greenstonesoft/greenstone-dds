...
namespace xtypes
{
    ...
    public:
         ...
         * @return DDS::ReturnCode_t::RETCODE_ERROR.
         */
         ...
         * @param [in] position Start position of this bitset member.
         * @return std::shared_ptr<AnnotationDescriptor> A bitset position annotation descriptor.
         */
        std::shared_ptr<AnnotationDescriptor> create_annotation_descriptor_with_position(
            uint32_t const position);
        
        /**
         * @brief Function to create an annotation descriptor with bitset bound information.
         * @param [in] bitcount Number of bits of this bitset member.
         * @return std::shared_ptr<AnnotationDescriptor> A bitset bound annotation descriptor.
         */
        std::shared_ptr<AnnotationDescriptor> create_annotation_descriptor_with_bitcount(
            uint32_t const bitcount);

        /**
         * @brief Function to create an annotation descriptor with optional.
         * @param [in] value True(DEFAULT) to implement an optional serialization
         * @return std::shared_ptr<AnnotationDescriptor> An optional annotation descriptor.
         */
        std::shared_ptr<AnnotationDescriptor> create_annotation_descriptor_with_optional();
