...
namespace qos {
    ...
    constexpr DDS::QosPolicyId_t DISABLEPOSITIVEACK_QOS_POLICY_ID{ 23U };   ///< DisablePositiveAckQosPolicy
    ...
    */
    ...
    public:
        ...
        /**
        * @brief This function serializies PresentationQosPolicy object with CDR serialization.
        * @param [in] cdr CDR serialization object.
        */
        inline gvoid_t serialize(DdsCdr& cdr) const noexcept
        {
            cdr.serialize(m_accessScope);
            cdr.serialize(m_coherentAccess);
            cdr.serialize(m_orderedAccess);
            return;
        }

        /**
        * @brief This function deserializies PresentationQosPolicy object with CDR deserialization.
        * @param [in] cdr CDR serialization object.
        */
        inline gvoid_t deserialize(DdsCdr& cdr) noexcept
        {
            cdr.deserialize(m_accessScope);
            cdr.deserialize(m_coherentAccess);
            cdr.deserialize(m_orderedAccess);
            return;
        }
        ...
        */
        ...
        inline friend gbool_t operator==(PresentationQosPolicy const &f1, PresentationQosPolicy const &f2) noexcept
        {
            ...
            gbool_t const kind_ret{f1.access_scope() == f2.access_scope()};
            return ((coh_ret) && (ord_ret) && (kind_ret));
        }
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief This function serializies HistoryQosPolicy object with CDR serialization.
        * @param [in] cdr CDR serialization object.
        */
        inline gvoid_t serialize(DdsCdr& cdr) const noexcept
        {
            cdr.serialize(m_kind);
            cdr.serialize(m_depth);
            return;
        }

        /**
        * @brief This function deserializies HistoryQosPolicy object with CDR deserialization.
        * @param [in] cdr CDR serialization object.
        */
        inline gvoid_t deserialize(DdsCdr& cdr) noexcept
        {
            cdr.deserialize(m_kind);
            cdr.deserialize(m_depth);
            return;
        }
    ...
    */
    ...
    private:
        bool m_autodisposeUnregisteredInstances{ true };
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief This function get unicast locator list.
        * @return Const reference of a sequence of locator.
        */
        inline gstone::rtps::LocatorList_t const& unicast_locatorList() const noexcept
        {
        ...
        */
        inline gstone::rtps::LocatorList_t& unicast_locatorList() noexcept {
            return m_unicastLocatorList;
        }

        /**
        * @brief This function set unicast locator list.
        * @param [in] locator_list_t Const reference of a sequence of locator to be set to.
        */
        inline void unicast_locatorList(gstone::rtps::LocatorList_t const& locator_list_t) noexcept 
        {
            m_unicastLocatorList = locator_list_t;
        }

        /**
        * @brief This function get multicast locator list.
        * @return Const reference of a sequence of locator.
        */
        inline gstone::rtps::LocatorList_t const& multicast_locatorList() const noexcept
        {
        ...
        * @return Reference of a sequence of locator.
        */
        inline gstone::rtps::LocatorList_t& multicast_locatorList() noexcept {
            return m_multicastLocatorList;
        }

        /**
        * @brief This function set multicast locator list.
        * @param [in] locator_list_t Const reference of a sequence of locator to be set to.
        */
        inline void multicast_locatorList(gstone::rtps::LocatorList_t const& locator_list_t) noexcept 
        {
            m_multicastLocatorList = locator_list_t;
        }


    private:
        ThreadScheduleSwitch m_kind{ ThreadScheduleSwitch::OFF };
        gstone::rtps::LocatorList_t m_unicastLocatorList{};
        gstone::rtps::LocatorList_t m_multicastLocatorList{};
    };

    /**
    * @brief This policy used for flow control.
    */
    class GS_DDS4CPP_API FlowControlQosPolicy : public QosPolicy
    {
    public:
        FlowControlQosPolicy() : QosPolicy {"FlowControl"} {}

        /**
        * @brief This function get flow control limits.
        * @return Limits of a flow control window.
        */
        inline guint32_t limits() const noexcept
        {
            return m_limits;
        }

        /**
        * @brief This function set flow control limits.
        */
        inline void limits(guint32_t const val) noexcept
        {
            m_limits = val;
        }

        /**
        * @brief This function get flow control period.
        * @return Period of a flow control window.
        */
        inline guint32_t period() const noexcept
        {
            return m_period;
        }

        /**
        * @brief This function set flow control period.
        */
        inline void period(guint32_t const val) noexcept
        {
            m_period = val;
        }

        /**
        * @brief This function serializies FlowControlQosPolicy object with CDR serialization.
        * @param [in] cdr CDR serialization object.
        */
       inline DdsCdr& serialize(DdsCdr& cdr) const noexcept
        {
            cdr.serialize(m_limits);
            cdr.serialize(m_period);
            return cdr;
        }

        /**
        * @brief This function deserializies FlowControlQosPolicy object with CDR deserialization.
        * @param [in] cdr CDR serialization object.
        */
        inline DdsCdr& deserialize(DdsCdr& cdr) noexcept
        {
            cdr.deserialize(m_limits);
            cdr.deserialize(m_period);
            return cdr;
        }

        /**
         * @brief Compare two FlowControlQosPolicy objects for size.
         * @param [in] f1_qos Const Reference of the left FlowControlQosPolicy object.
         * @param [in] f2_qos Const Reference of the right FlowControlQosPolicy object.
         * @return Return true if left less than right, else return false. 
         */
        inline friend gbool_t operator<(FlowControlQosPolicy const& l_flowctl_qos, FlowControlQosPolicy const& r_flowctl_qos) noexcept
        {
            if((l_flowctl_qos.m_period == 0U) || (r_flowctl_qos.m_period == 0U))
            {
                return false;
            }
            guint32_t const l_val {(l_flowctl_qos.m_limits * 1000000U) / (l_flowctl_qos.m_period)};
            guint32_t const r_val {(r_flowctl_qos.m_limits * 1000000U) / (r_flowctl_qos.m_period)};
            if(l_val < r_val)
            {
                return true;
            }
    ...
    private:
        guint32_t m_limits {0U};
        guint32_t m_period {0U};
    };

    class GS_DDS4CPP_API DisablePositiveACKsQosPolicy : public QosPolicy
    {
    public:
        DisablePositiveACKsQosPolicy() : QosPolicy{"DisablePositiveACKs"}
        {
        }

        DisablePositiveACKsQosPolicy(gbool_t enabled, guint64_t val_ms) : QosPolicy{"DisablePositiveACKs"}, m_enabled{enabled}, m_duration{val_ms}
        {
        }

        gbool_t enabled() const noexcept
        {
            return m_enabled;
        }

        gvoid_t enabled(gbool_t val) noexcept
        {
            m_enabled = val;
        }

        gstone::rtps::Duration_t const& duration() const noexcept
        {
            return m_duration;
        }
       ...
       inline DdsCdr& serialize(DdsCdr& cdr) const noexcept
        {
            cdr.serialize(m_enabled);
            return cdr;
        }

        inline DdsCdr& deserialize(DdsCdr& cdr) noexcept
        {
            cdr.deserialize(m_enabled);
            return cdr;
        }

    private:
        gbool_t m_enabled{false};
        gstone::rtps::Duration_t m_duration{gstone::rtps::Duration_t::duration_infinite()};
    };

    class GS_DDS4CPP_API EntityNameQosPolicy: public QosPolicy {
    public:
        EntityNameQosPolicy()
            : QosPolicy{ "EntityName" }, m_name { "" }
            {}

        inline gstring_t name() const noexcept
        {
            return m_name;
        }

        inline void name(gstring_t const& value) noexcept
        {
            m_name = value;
        }
    private:
    ...
    /**
    * @brief This policy controls the behavior of the ThreadInstanceConfigQosPolicy init status when acting as a factory create.
    */
    class GS_DDS4CPP_API ThreadInstanceConfigQosPolicy : public QosPolicy
    {
    public:
        ThreadInstanceConfigQosPolicy() : QosPolicy{ "ThreadInstanceConfig" } {}

        /**
        * @brief Set the ThreadInstanceStatus.
        * @param [in] status Const of a status.
        */
        inline gvoid_t thread_instance_status(gbool_t const status) noexcept
        {
            m_threadInstanceStatus = status;
        }

        /**
        * @brief Retrieve the ThreadInstanceStatus.
        * @return ThreadInstanceStatus.
        */
        inline gbool_t thread_instance_status() const noexcept
        {
            return m_threadInstanceStatus;
        }

        /**
        * @brief Set the ThreadInstanceConfigQosPolicy AsyncThreadNum.
        * @param [in] status Const of a number.
        */
        inline gvoid_t async_thread_num(guint32_t const num) noexcept
        {
            m_asyncThreadNum = num;
        }

        /**
        * @brief Retrieve the ThreadInstanceConfigQosPolicy AsyncThreadNum.
        * @return ThreadInstanceConfigQosPolicy AsyncThreadNum.
        */
        inline guint32_t async_thread_num() const noexcept
        {
            return m_asyncThreadNum;
        }

        /**
         * @brief Compare two ThreadInstanceConfigQosPolicy objects for equailty.
         * @param [in] f1_qos Const Reference of the left ThreadInstanceConfigQosPolicy object.
         * @param [in] f2_qos Const Reference of the right ThreadInstanceConfigQosPolicy object.
         * @return Return true if equality, else return false. 
         */
        inline friend gbool_t operator==(ThreadInstanceConfigQosPolicy const& f1_qos, ThreadInstanceConfigQosPolicy const& f2_qos) noexcept
        {
            if ((f1_qos.thread_instance_status() == f2_qos.thread_instance_status()) && (f1_qos.async_thread_num() == f2_qos.async_thread_num()))
            {
                return true;
            }
            return false;
        ...
        /**
         * @brief Compare two ThreadInstanceConfigQosPolicy objects for inequailty.
         * @param [in] f1_qos Const Reference of the left ThreadInstanceConfigQosPolicy object.
         * @param [in] f2_qos Const Reference of the right ThreadInstanceConfigQosPolicy object.
         * @return Return true if inequality, else return false. 
         */
    ...
    private:
        gbool_t m_threadInstanceStatus{ false };
        guint32_t m_asyncThreadNum {1U};
        
    };

    /**
    * @brief This enum class defines different kinds of ConcurrencyControlQosPolicy.
    */
    enum class ConcurrencyControlKind : guint32_t
    {
        LEVEL_OFF = 0x00,

        LEVEL_INTRA_PARTICIPANT,

        LEVEL_CROSS_PARTICIPANT
    };

    /**
    * @brief This policy use for the ConcurrencyControlQosPolicy.
    */
    class GS_DDS4CPP_API ConcurrencyControlQosPolicy : public QosPolicy
    {
    public:
        ConcurrencyControlQosPolicy() : QosPolicy{ "ConcurrencyControl" } {}

        /**
        * @brief Set the ConcurrencyControlKind.
        * @param [in] _kind Const of a kind.
        */
        inline gvoid_t kind(ConcurrencyControlKind const _kind) noexcept
        {
            m_kind = _kind;
        }

        /**
        * @brief Retrieve the ConcurrencyControlKind.
        * @return ConcurrencyControlKind.
        */
        inline dds::qos::ConcurrencyControlKind kind() const noexcept
        {
            return m_kind;
        }

        /**
        * @brief Set the competition_avoid_duration.
        * @param [in] val Const of a val, the unit is microseconds.
        */
        inline gvoid_t competition_avoid_duration(guint64_t const val) noexcept
        {
            m_competitionAvoidDuration = val;
        }

        /**
        * @brief Retrieve the competition_avoid_duration.
        * @return competition_avoid_duration,the unit is microseconds.
        */
        inline guint64_t competition_avoid_duration() const noexcept
        {
            return m_competitionAvoidDuration;
        }

        /**
         * @brief Compare two ConcurrencyControlQosPolicy objects for equailty.
         * @param [in] f1_qos Const Reference of the left ConcurrencyControlQosPolicy object.
         * @param [in] f2_qos Const Reference of the right ConcurrencyControlQosPolicy object.
         * @return Return true if equality, else return false. 
         */
        inline friend gbool_t operator==(ConcurrencyControlQosPolicy const& f1_qos, ConcurrencyControlQosPolicy const& f2_qos) noexcept
        {
            if ((f1_qos.kind() == f2_qos.kind()) && (f1_qos.competition_avoid_duration() == f2_qos.competition_avoid_duration()))
            {
                return true;
            }
            return false;
        ...
        /**
         * @brief Compare two ConcurrencyControlQosPolicy objects for inequailty.
         * @param [in] f1_qos Const Reference of the left ConcurrencyControlQosPolicy object.
         * @param [in] f2_qos Const Reference of the right ConcurrencyControlQosPolicy object.
         * @return Return true if inequality, else return false. 
         */
    ...
    private:
        ConcurrencyControlKind m_kind{ ConcurrencyControlKind::LEVEL_OFF };
        guint64_t m_competitionAvoidDuration{0U};
        
    };

    /**
    * @brief This policy use for the NetworkPortRangeQosPolicy.
    */
    class GS_DDS4CPP_API NetworkPortRangeQosPolicy : public QosPolicy
    {
    public:
        NetworkPortRangeQosPolicy() : QosPolicy{ "NetworkPortRange" } {}

        /**
        * @brief Set the port_range_begin.
        * @param [in] _port Const of guint32_t.
        */
        inline gvoid_t port_range_begin(guint32_t const _port) noexcept
        {
            m_portRangeBegin = _port;
        }

        /**
        * @brief Retrieve the port_range_begin.
        * @return guint32_t.
        */
        inline guint32_t port_range_begin() const noexcept
        {
            return m_portRangeBegin;
        }

        /**
        * @brief Set the port_range_end.
        * @param [in] _port Const of guint32_t.
        */
        inline gvoid_t port_range_end(guint32_t const _port) noexcept
        {
            m_portRangeEnd = _port;
        }

        /**
        * @brief Retrieve the port_range_end.
        * @return guint32_t.
        */
        inline guint32_t port_range_end() const noexcept
        {
            return m_portRangeEnd;
        }

        /**
        * @brief Retrieve the NetworkPortRangeQosPolicy configuration whether valid.
        * @return guint32_t.
        */
        inline gbool_t port_range_valid() const noexcept
        {
            return ((m_portRangeBegin < m_portRangeEnd) && (m_portRangeBegin > 0U) && (m_portRangeEnd <= 65535U));
        }

        /**
         * @brief Compare two NetworkPortRangeQosPolicy objects for equailty.
         * @param [in] f1_qos Const Reference of the left NetworkPortRangeQosPolicy object.
         * @param [in] f2_qos Const Reference of the right NetworkPortRangeQosPolicy object.
         * @return Return true if equality, else return false. 
         */
        inline friend gbool_t operator==(NetworkPortRangeQosPolicy const& f1_qos, NetworkPortRangeQosPolicy const& f2_qos) noexcept
        {
            if ((f1_qos.port_range_begin() == f2_qos.port_range_begin()) && (f1_qos.port_range_end() == f2_qos.port_range_end()))
            {
                return true;
            }
            return false;
        ...
        /**
         * @brief Compare two NetworkPortRangeQosPolicy objects for inequailty.
         * @param [in] f1_qos Const Reference of the left NetworkPortRangeQosPolicy object.
         * @param [in] f2_qos Const Reference of the right NetworkPortRangeQosPolicy object.
         * @return Return true if inequality, else return false. 
         */
    ...
    private:
        guint32_t m_portRangeBegin{0U};
        guint32_t m_portRangeEnd{0U};
