		...
		*/
		...
		public:
			...
			*/
			...
			/**
			 * @brief constructor
			 * @param [in] class_id,the speficied class id
			*/
			DataHolder( gstring_t const& class_id);
			...
			*/
			 ...
			 * @param class_id 
			*/
			gvoid_t set_class_id(gstring_t const & class_id) noexcept
			{
			...
			*/
			 ...
			 * @return PropertySeq 
			*/
			PropertySeq properties() const noexcept
			{
				return m_properties;
			}
			...
			*/
			BinaryPropertySeq const & binary_properties() const
			{
