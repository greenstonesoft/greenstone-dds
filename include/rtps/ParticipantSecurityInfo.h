...
// #define PARTICIPANT_SECURITY_INFO_DEFAULT_ATTRIBUTES {0, 0}
		...
		*/
		class GS_DDS4CPP_API ParticipantSecurityAttributes final
		{
			...
			*/
			 ...
			 * @note no exception
			*/
			ParticipantSecurityAttributes& operator=( ParticipantSecurityAttributes const& part_other) noexcept
			{
				if (this != &part_other)
				{
					this->allow_unauthenticated_participants = part_other.allow_unauthenticated_participants;
					this->is_access_protected = part_other.is_access_protected;
					this->is_rtps_protected = part_other.is_rtps_protected;
					this->is_discovery_protected = part_other.is_discovery_protected;
					this->is_liveliness_protected = part_other.is_liveliness_protected;
					this->plugin_participant_attributes = part_other.plugin_participant_attributes;
				}
			...
			*/
			 ...
			 * @note no exception
			*/
			inline gbool_t security_mask_matches( guint32_t const& local_mask,  guint32_t const& remote_mask) const noexcept
			{
			...
			*/
			...
			{
				return ((this->plugin_participant_attributes & plugin_mask) != 0);
			}
		...
		*/
		...
		// typedef ParticipantSecurityInfo ParticipantSecurityInfo_t;

	}/*security*/
}/*gstone*/
typedef gstone::security::ParticipantSecurityInfo ParticipantSecurityInfo;
