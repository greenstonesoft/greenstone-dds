...
namespace xtypes
{
    ...
    public:
        ...
        */
        ...
        MemberDescriptor(
            ...
            std::vector<uint64_t> const &union_labels,
    ...
    public:
         ...
         */
        inline std::vector<uint64_t> get_union_labels() const
        {
            return m_label;
        }
    ...
    private:
        ...
        * @param [in] default_label The new MemberDescriptor object's default_label.
        ...
        */
        MemberDescriptor(
            ...
            std::string const &default_value,
            uint32_t const _index,
            std::vector<uint64_t> const &labels,
        ...
        std::vector<uint64_t> m_label;                                          // Case Labels for unions.
        bool m_defaultLabel;                                                    // TRUE if it's the default option of a union.
