...
namespace xtypes
{
    ...
    public:
         ...
         * @return DDS::ReturnCode_t DDS::ReturnCode_t::RETCODE_OK if add member successfully, otherwise return DDS::ReturnCode_t::RETCODE_BAD_PARAMETER.
         */
         ...
         * @param [in] bitset_position Start potion of this bitset member.
         * @param [in] bitset_bound Number of bits that can be stored (its size). The maximum value is 64.
         * @param [in] destination_type Type that will be used to manipulate the bit field as a whole.
        ...
        DDS::ReturnCode_t add_member(
            ...
            DynamicType_ptr const destination_type,
            std::string const &name);
