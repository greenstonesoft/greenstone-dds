...
#include "dcps/core/StatusCondition.h"
#include "dcps/core/ReadCondition.h"
#include "dcps/core/QueryCondition.h"
#include "dcps/core/CoreTypes.h"
#include "dcps/topic/TopicDescription.h"
#include "dcps/sub/DataReaderQos.h"

#include "dcps/topic/PublicationBuiltinTopicData.h"
#include "dcps/sub/LoanableTypeData.h"
#include "dcps/sub/SamplesCollectionBase.h"
#include <mutex>
...
namespace sub
{
    ...
    public:
         ...
         * @param [in] qos reader's qos
         * @return Return Code
         * @retval DDS::ReturnCode_t::RETCODE_OK nothing wrong
         */
        DDS::ReturnCode_t set_qos(DataReaderQos const& qos) noexcept;
        
        /**
         * @brief Get the qos object
         * @param [in,out] qos reader's qos
         * @return Return Code
         * @retval DDS::ReturnCode_t::RETCODE_OK nothing wrong
         */
        DDS::ReturnCode_t get_qos(DataReaderQos& qos) const noexcept;
         ...
         */
        DDS::ReturnCode_t read(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            DDS::SampleStateMask const sample_state,
            DDS::ViewStateMask const view_state,
            DDS::InstanceStateMask const instance_state) noexcept;
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t take(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            DDS::SampleStateMask const sample_state,
            DDS::ViewStateMask const view_state,
            DDS::InstanceStateMask const instance_state) noexcept;
        ...
        DDS::ReturnCode_t take(
            ...
            DDS::SampleStateMask const sample_state = static_cast<DDS::SampleStateMask>(1),
            DDS::ViewStateMask const view_state = static_cast<guint32_t>(DDS::ViewStateKind::NEW_VIEW_STATE),
            DDS::InstanceStateMask const instance_state = DDS::InstanceStateKind::ALIVE_INSTANCE_STATE) noexcept;
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t read_w_condition(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t take_w_condition(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            dds::core::ReadCondition const * const a_condition) noexcept;
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t read_instance(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t take_instance(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            gstone::rtps::InstanceHandle_t const handle,
            DDS::SampleStateMask const sample_state,
            DDS::ViewStateMask const view_state,
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t read_next_instance(void * const data_value, dds::core::SampleInfoSeq const&sample_info,
            gint32_t const max_samples,
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t take_next_instance(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            gstone::rtps::InstanceHandle_t const previous_handle,
            DDS::SampleStateMask const sample_state,
            DDS::ViewStateMask const view_state,
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t read_next_instance_w_condition(void * const  data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            gstone::rtps::InstanceHandle_t const previous_handle,
            dds::core::ReadCondition const* const a_condition) const noexcept;
         ...
         * @retval DDS::ReturnCode_t::RETCODE_BAD_PARAMETER parameters are illegal.
         */
        DDS::ReturnCode_t take_next_instance_w_condition(void * const data_value, dds::core::SampleInfoSeq const &sample_info,
            gint32_t const max_samples,
            gstone::rtps::InstanceHandle_t const previous_handle,
            dds::core::ReadCondition const* const a_condition) const noexcept;
