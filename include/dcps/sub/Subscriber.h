...
namespace sub
{
    ...
    */
    ...
    public:
         ...
         * @retval DDS::ReturnCode_t::RETCODE_OK nothing wrong
         */
        DDS::ReturnCode_t get_datareaders() const noexcept;
         ...
         */
        DDS::ReturnCode_t copy_from_topic_qos(DataReaderQos const &a_datareader_qos, dds::topic::TopicQos const &a_topic_qos) const noexcept;
