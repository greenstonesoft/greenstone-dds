...
#include "rtps/TopicDataType.h"
#include "rtps/UtilHelper.h"
...
{
    /**
     * @brief This class is an adapter that allows using DynamicData on Fast DDS. It inherits from TopicDataType and
    ...
    public:
         ...
         */
        gbool_t get_key(gvoid_t* data, gstone::rtps::InstanceHandle_t* ihandle) override;
         ...
         * @return gbool_t True if correct.
         */
        gbool_t get_key(std::shared_ptr<gstone::rtps::SerializedPayload_t> data_value, gstone::rtps::InstanceHandle_t* ihandle) override;
         ...
         * @return gbool_t 
         */
        gbool_t serialize(DdsCdr &cdr, gvoid_t *data, std::shared_ptr<gstone::rtps::SerializedPayload_t> data_value) noexcept override;
         ...
         * @return gbool_t 
         */
        gbool_t deserialize(DdsCdr &cdr, std::shared_ptr<gstone::rtps::SerializedPayload_t> data_value, gvoid_t *data) noexcept override;
    private:
